...
lib.ssMetadata = [
		{name:"version1_atlas_", frames: [[0,0,1920,1080]]},
		{name:"version1_atlas_2", frames: [[0,0,1102,1461]]},
		{name:"version1_atlas_3", frames: [[0,1115,1154,824],[0,0,1160,1113],[1156,1115,596,842],[1162,0,596,842]]},
		{name:"version1_atlas_4", frames: [[504,844,68,123],[0,844,502,195],[0,0,596,842]]}
];
...
(lib.CachedTexturedBitmap_10 = function() {
	this.initialize(ss["version1_atlas_4"]);
	this.gotoAndStop(0);
...
(lib.CachedTexturedBitmap_13 = function() {
	this.initialize(ss["version1_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedTexturedBitmap_14 = function() {
	this.initialize(ss["version1_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.pineapple = function() {
	this.initialize(ss["version1_atlas_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Scene_1_rain = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},119).wait(50));
...
// stage content:
(lib.version1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(722).call(this.frame_722).wait(1));
	...
	this.walktobeach1.layerIndex = 6
	...
	this.bluebackround.layerIndex = 7
	...
	this.windowsummer.layerIndex = 8
	...
	this.after120days.layerIndex = 9
	...
	this.Layer_9.setTransform(288,202.3,1,1,0,0,0,288,202.3);
	this.Layer_9.depth = 0;
	this.Layer_9.isAttachedToCamera = 0
	this.Layer_9.isAttachedToMask = 0
	this.Layer_9.layerDepth = 0
	this.Layer_9.layerIndex = 18
	this.Layer_9.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.Layer_9).to({_off:true},119).wait(604));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/version1_atlas_.png", id:"version1_atlas_"},
		{src:"images/version1_atlas_2.png", id:"version1_atlas_2"},
		{src:"images/version1_atlas_3.png", id:"version1_atlas_3"},
		{src:"images/version1_atlas_4.png", id:"version1_atlas_4"}
	],
	preloads: []
};
